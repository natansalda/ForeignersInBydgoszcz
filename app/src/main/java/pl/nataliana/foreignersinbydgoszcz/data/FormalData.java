...
public class FormalData {
    ...
    public static String[] descriptionArray = {
            ...
            "Accepting applications regarding Polish citizenship takes place in the following hours:\n" +
                    "Monday, Wednesday, Thursday 8.00 am to 1.00 pm, Tuesday 8.00 am to 2.00 pm \n" +
                    "room 202  (2nd floor, building C), phone (52) 349-7231\n",
            "This modern tool helps quickly and easily complete an online interactive application form for legalisation of stay and international protection.",
            "To receive the Bydgoszcz City Card, you must apply for a card. Applications can be submitted personally at the Customer Service Center (Toruńska street 174A; Monday-Friday 7.00 am to 5.00 pm), at the Customer Service Point (Zygmunta Augusta street 10, Monday-Friday 8.00 am to 6.30 pm) or via the website: https://wnioski.bydgoskakartamiejska.com.pl/\n" +
                    " \n" +
                    "After submitting the application, the card can be picked up in person at the Customer Service Center or at the Customer Service Point, depending on the place of application.\n" +
                    " \n" +
                    "WARNING! In the case of an application submitted online, the card can be picked up only at the Customer Service Center. The Bydgoszcz City Card as a carrier of public transport tickets can be issued as a personal or bearer card.\n" +
                    " \n" +
                    "In the case of applying for a naming card, attach a current photo with dimensions of min. 2.5 x 3 cm (eg current photo for school / student ID card, passport or ID card). The picture for personalizing the card can also be made free of charge in COK or POK.\n",
            "Vehicle Registration Section at the Department of Communication Permits of the City of Bydgoszcz\n" +
    ...
    public static String[] addressArray = {
            "Information: phone: (52) 349-7720, (52) 349-7721\n" +
                    "2nd floor, building C, enter from 1-3 Konarskiego st\n" +
                    "room no: 204, 207, 208, 240,242 \n" +
                    "e-mail: paszport@bydgoszcz.uw.gov.pl\n",
            "room no 81 F, buliding B, 8th floor, 1-3 Konarskiego st\n" +
                    "phone. (52) 34-97-249\n" +
                    "e-mail: cudzoziemiec@bydgoszcz.uw.gov.pl\n",
            "1-3 Konarskiego st, room no 200, 202, 203, 238, 239 (2nd floor, building C)\n" +
                    "phone (52) 349-7234\n" +
                    "e-mail: emejgier@bydgoszcz.uw.gov.pl\n",
