...
public class PlacesData {
    ...
    public static String[] descriptionArray = {"1.5", "1.6", "2.0-2.1", "2.2-2.2.3", "2.3-2.3.7", "3.0-3.2.6", "4.0-4.0.4", "4.1-4.3.1", "4.4-4.4.4", "5.0-5.1.1","6.0-6.0.1"};
    ...
    public static String[] addressArray = {"Mill Island (Wyspa Młyńska)", "Opera Nova", "Main Post Office", "Cathedral", "Bydgoszcz Canal", "Old granaries", "Valley of Death","St. Vincent de Paul Basilica Minor", "King Kasimir the Great Monument", "Pomeranian Philharmonic", "City Hall"};
}
